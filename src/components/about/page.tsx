    ...
    <div className='bg-black text-white py-20' id='about'>
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
        ...
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
            <img src='/aboutme.jpg' alt="" className='w-72 h-80 rounded object-cover mb-8 md:mb-0'/>
            <div className='flex-1'>
            <p className='text-lg mb-8'>
                I am Passionate Frontend Web Developer with a focus on building modern and responsive web applications. With a strong foundation in Frontend technologies, I strive to create seamless and efficient user experiences.
            </p>
